      ...
      <div className="my-10">
        ...
        <div className="m-auto w-[90%] md:w-[75%]">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-[blue]">About Us</h3>
            <h2 className="m-auto w-[60%] py-6 text-4xl font-bold text-black md:text-7xl">
              We are Momentum!
            </h2>
          ...
          <div className="m-auto my-28 w-[90%] md:w-[75%]">
            <div className="self-center">
              ...
              <div className="my-8 flex">
                <NavLink to="/quote">
                  <button className="flex rounded-xl bg-[blue] px-7 py-3 font-semibold text-white hover:bg-black  md:py-4">
                    CONTACT US{" "}
        ...
        <div className="">
          <div className="m-auto grid grid-cols-1 justify-items-center gap-10 py-20 md:w-[60%] md:grid-cols-3 md:gap-0">
            <div className="m-auto flex gap-3 justify-self-center border-b-8 border-blue-400 pb-5 text-center md:w-[100%]">
              <div>
                <h3 className="text-6xl font-bold text-black md:text-7xl">
                  +7
                </h3>
              </div>
              <div>
          ...
          <div className="flex justify-center">
            <NavLink to="">
              {" "}
              <button className="flex rounded-md bg-[blue] px-4 py-2 font-semibold text-white hover:bg-black ">
                VIEW OUR SERVICES{" "}
                <FaGreaterThan className="inline self-center ps-2" />
              </button>
            </NavLink>
